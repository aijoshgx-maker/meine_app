...
class SchnittdatenPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint
      ...
      ..style = PaintingStyle.fill;
    canvas.drawRect(
      Rect.fromLTRB(toolLeft, toolTop, toolRight, toolBot),
      paint,
    );
    paint
      ..color = cs.primary
    ...
    _pfeil(
      canvas,
      Offset(toolRight, cy - h * 0.20),
      Offset(toolRight - w * 0.10, cy - h * 0.20),
      cs.secondary,
      paint,
    );
    _label(
      canvas,
      'f  (Vorschub)',
      Offset(toolRight - w * 0.10 - 4, cy - h * 0.32),
    ...
    _pfeil(
      canvas,
      Offset(apX, cy - h * 0.08),
      Offset(apX, cy - h * 0.34),
      cs.error,
      paint,
    );
    _pfeil(
    ...
    _pfeil(
      canvas,
      Offset(
        cx + r * 1.12 * cos(-pi * 0.7 + pi * 0.9 - 0.05),
        cy + r * 1.12 * sin(-pi * 0.7 + pi * 0.9 - 0.05),
      ),
      Offset(
        cx + r * 1.12 * cos(-pi * 0.7 + pi * 0.9),
