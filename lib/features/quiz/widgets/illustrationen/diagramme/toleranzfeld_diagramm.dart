...
class ToleranzfeldPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _text(
      canvas,
      'IT = ES − EI',
      Offset(left + 4, (boxTop + boxBot) / 2 - 6),
      ts,
      cs.primary,
    );
    ...
    paint
      ...
      ..style = PaintingStyle.stroke;
    canvas.drawRect(
      Rect.fromLTRB(left * 0.18, h * 0.18, left * 0.95, h * 0.82),
      paint,
    );
    _text(
      canvas,
