...
class Pneumatik52VentilPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _linie(
      canvas,
      Offset(x1 + 4, yTop + boxH - 4),
      Offset(x1 + boxW - 4, yTop + 4),
      cs.primary,
      1.5,
      paint,
    );
    ...
    _linie(
      canvas,
      Offset(x2 + boxW * 0.25, yTop + 4),
      Offset(x2 + boxW * 0.25, yTop + boxH - 4),
      cs.outline,
      1.5,
      paint,
    );
    _linie(
      canvas,
      Offset(x2 + boxW * 0.75, yTop + 4),
      Offset(x2 + boxW * 0.75, yTop + boxH - 4),
      cs.outline,
      1.5,
      paint,
    );
    ...
    _anschluss(
      canvas,
      Offset(x1 + boxW * 0.25, yUnten),
      Offset(x1 + boxW * 0.25, portY1),
      'R',
      false,
      paint,
      cs,
    ...
    _anschluss(
      canvas,
      Offset(x2 + boxW * 0.75, yUnten),
      Offset(x2 + boxW * 0.75, portY1),
      'S',
      false,
      paint,
      cs,
    ...
    _anschluss(
      canvas,
      Offset(x1 + boxW * 0.25, yOben),
      Offset(x1 + boxW * 0.25, portY2),
      'A',
      true,
      paint,
      cs,
    ...
    _anschluss(
      canvas,
      Offset(x2 + boxW * 0.75, yOben),
      Offset(x2 + boxW * 0.75, portY2),
      'B',
      true,
      paint,
      cs,
    ...
    paint
      ...
      ..style = PaintingStyle.fill;
    canvas.drawRect(
      Rect.fromLTWH(magLeft, magTop, w * 0.09, magBot - magTop),
      paint,
    );
    paint
      ..color = cs.secondary
    ...
    _linie(
      canvas,
      Offset(magLeft + w * 0.025, magTop + 4),
      Offset(magLeft + w * 0.025, magBot - 4),
      cs.secondary,
      1,
      paint,
    );
  ...
  void _anschluss(
    ...
    tp.paint(
      canvas,
      Offset(to.dx - tp.width / 2, oben ? to.dy - tp.height - 2 : to.dy + 2),
    );
  }
